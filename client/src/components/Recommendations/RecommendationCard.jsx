...
/* ── Score display with optional confidence interval ── */
  ...
  return (
    <div className="flex flex-col items-center gap-0.5">
      ...
      {hasRange && halfWidth > 0 && (
        <span className="text-[9px] text-slate-500 tabular-nums" title={`Fourchette : ${scoreRange[0].toFixed(0)} – ${scoreRange[1].toFixed(0)}`}>
          ±{halfWidth}
        </span>
      )}
    </div>
